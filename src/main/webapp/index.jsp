			...
			<div class="col-md-3">
				<div class="card crd-ho">
					<div class="card-body text-center">
						<img alt="" src="book/<%=b.getCover() %>" style="height: 200px; width: 150px;"
							class="img-thumblin">
						<p>
							<b><%=b.getBookname() %></b>
						</p>
						...
						%>
								<div class="row text-center">
									<a href="login.jsp" class="btn btn-success btn-sm ml-5">View Book</a> 
									<a href="login.jsp" class="btn btn-danger btn-sm ml-1"><i class="fa-solid fa-indian-rupee-sign"></i> <%=b.getPrice() %></a>
								</div>
						<%
							}
							else{
						...
						<div class="row  text-center">
							...
							<a href="login.jsp" class="btn btn-success btn-sm ml-1">View Book</a> 
							<a href="login.jsp" class="btn btn-danger btn-sm ml-1"><i class="fa-solid fa-indian-rupee-sign"></i> <%=b.getPrice() %></a>
						</div>
						<%
							}
